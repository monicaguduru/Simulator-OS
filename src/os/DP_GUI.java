...
public class DP_GUI extends JFrame implements WindowListener,ActionListener 
{
        ...
        {        	
                ...
                textField_2.setBounds(66, 384, 17, 14);
                textField_2.setBackground(new Color(255, 0, 0));
                textField_2.setColumns(10);
                textField_1.setBounds(66, 338, 17, 14);
                textField_1.setBackground(new Color(255, 215, 0));
                textField_1.setColumns(10);
                textField.setBounds(66, 286, 17, 14);
                ...
                b1.setBounds(95, 191, 75, 32);
                b1.setForeground(new Color(250, 240, 230));
                b1.setBackground(new Color(204, 102, 102));
                getContentPane().add(b1);
                text1.setBounds(492, 119, 72, 22);
                getContentPane().add(text1);
                text2.setBounds(249, 305, 75, 22);
                getContentPane().add(text2);
                text3.setBounds(337, 577, 75, 22);
                getContentPane().add(text3);
                text4.setBounds(638, 577, 75, 22);
                getContentPane().add(text4);
                text5.setBounds(741, 305, 75, 22);
                getContentPane().add(text5);
                text6.setForeground(new Color(0, 0, 0));
                text6.setBackground(new Color(189, 183, 107));
                text6.setBounds(101, 545, 42, 32);
                getContentPane().add(text6);
                
                getContentPane().add(textField);
                lblThinking.setFont(new Font("Gabriola", Font.BOLD, 19));
                lblThinking.setBounds(95, 281, 83, 24);
                
                getContentPane().add(lblThinking);
                
                getContentPane().add(textField_1);
                lblEating.setFont(new Font("Gabriola", Font.BOLD, 19));
                lblEating.setBounds(95, 330, 75, 33);
                
                getContentPane().add(lblEating);
                
                getContentPane().add(textField_2);
                lblHungry.setFont(new Font("Gabriola", Font.BOLD, 19));
                lblHungry.setBounds(95, 376, 96, 32);
                ...
                textField_3.setBounds(161, 119, 65, 22);
                ...
                lblEnterTheRuntime.setForeground(new Color(0, 0, 0));
                lblEnterTheRuntime.setBounds(32, 112, 150, 32);
                getContentPane().add(lblEnterTheRuntime);
                //JLabel label_1 = new JLabel("");
        		Image images = new ImageIcon(Loginview.class.getResource("/111.jpg")).getImage();
                
                label_3.setBounds(238, 0, 578, 599);
                Image images1 = new ImageIcon(Loginview.class.getResource("/img2.png")).getImage();
        		label_3.setIcon(new ImageIcon(images1));
