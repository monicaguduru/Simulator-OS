...
public class PageFaultGUI {
	...
	private JLabel lblSimulator_1;
	private JLabel lblSimulator;
	...
	private void initialize() 
	{
		...
		btnStart.setBounds(53, 325, 84, 34);
		...
		btnSecondchance.setBounds(561, 324, 84, 36);
		...
		btnOptimal.setBounds(780, 323, 84, 36);
		...
		textField_5.setBounds(431, 179, 46, 20);
		textField_5.setBackground(new Color(238, 232, 170));
		frame.getContentPane().add(textField_5);
		textField_5.setColumns(10);
		
		JLabel lblNoOfFrames = new JLabel("No of Frames");
		lblNoOfFrames.setBounds(224, 177, 135, 20);
		lblNoOfFrames.setForeground(new Color(0, 255, 0));
		lblNoOfFrames.setFont(new Font("Comic Sans MS", Font.PLAIN, 16));
		...
		btnCompare.setBounds(402, 529, 151, 34);
		...
		textField_7.setBounds(431, 245, 46, 20);
		frame.getContentPane().add(textField_7);
		textField_7.setColumns(10);
		
		lblLengthOfInput = new JLabel("Length of Input String");
		lblLengthOfInput.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblLengthOfInput.setBounds(224, 244, 172, 21);
		lblLengthOfInput.setForeground(new Color(0, 255, 0));
		frame.getContentPane().add(lblLengthOfInput);
		
		lblSimulator_1 = new JLabel("SIMULATOR");
		lblSimulator_1.setBackground(new Color(0, 0, 0));
		Image images = new ImageIcon(Loginview.class.getResource("/112.jpg")).getImage();
		lblSimulator_1.setIcon(new ImageIcon(images));
		lblSimulator_1.setBounds(0, 83, 982, 520);
		frame.getContentPane().add(lblSimulator_1);
		
		lblSimulator = new JLabel("PAGE FAULT ALGORITHMS");
		lblSimulator.setFont(new Font("Gabriola", Font.BOLD, 34));
		lblSimulator.setForeground(new Color(0, 0, 0));
		lblSimulator.setBounds(307, 13, 381, 72);
